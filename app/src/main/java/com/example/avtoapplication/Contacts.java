...
public class Contacts {
    ...
    public static final int DATABASE_VERSION = 2;// версия баззы данных

    public static final String TABLE_NAME = "CONTACT_TABLE"; // назвыание таблицы

    // перечень набора полей который будут в таблице
